...
class Main(QtGui.QMainWindow):
    ...
    def __init__(self,parent=None,p2=1):
    ...
    def initToolbar(self):
        ...
        if self.p2:
            self.previewAction = QtGui.QAction(QtGui.QIcon("icons/xml.png"),"Generate XML",self)
            self.previewAction.setStatusTip("Generate XML")
    ...
    def preview(self):
        ...
        #preview.paintRequested.connect(lambda p: xml.print_(p))
